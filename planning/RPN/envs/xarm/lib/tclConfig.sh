...
# installed.
TCL_PREFIX='/media/pavan/STORAGE/linux_storage/RPN/envs/xarm'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/media/pavan/STORAGE/linux_storage/RPN/envs/xarm'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /media/pavan/STORAGE/linux_storage/RPN/envs/xarm/include -fdebug-prefix-map=/croot/tk_1714770549989/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/media/pavan/STORAGE/linux_storage/RPN/envs/xarm=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /media/pavan/STORAGE/linux_storage/RPN/envs/xarm/include'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/media/pavan/STORAGE/linux_storage/RPN/envs/xarm/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/media/pavan/STORAGE/linux_storage/RPN/envs/xarm/include'
...
TCL_PACKAGE_PATH='{/media/pavan/STORAGE/linux_storage/RPN/envs/xarm/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/media/pavan/STORAGE/linux_storage/RPN/envs/xarm/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1714770549989/work/tcl8.6.14/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/media/pavan/STORAGE/linux_storage/RPN/envs/xarm/lib/libtclstub8.6.a'
